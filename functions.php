<?php
    ...
    function selectAllDirectories($somePath){
        ...
        foreach($directories as $dir){
            ...
            $fileName = substr($link[0],1);
            echo '<div class="folder"><a class="folderLink" href="'.$fileName.'.php"><img src="folder.png" 
            class="folderLink" alt="'.$link[0].'" style="width:100px;height:100px;"></a></div>
            ';
        }
        echo '</div>';
    }